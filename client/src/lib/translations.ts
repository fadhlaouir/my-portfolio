...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'experience.rbk.description': 'Mentored 50+ junior developers in full-stack JavaScript development. Created comprehensive curriculum covering React, Node.js, Express, and MongoDB. Delivered technical workshops on modern development practices, testing methodologies, and deployment strategies. Achieved 85% student job placement rate within 6 months of graduation.',
  ...
  fr: {
    ...
    'experience.rbk.description': 'Mentorat de 50+ développeurs juniors en développement JavaScript full-stack. Création de curriculum compréhensif couvrant React, Node.js, Express et MongoDB. Animation d\'ateliers techniques sur les pratiques de développement modernes, méthodologies de test et stratégies de déploiement. Atteinte de 85% de taux de placement professionnel dans les 6 mois suivant la graduation.',
  ...
  ar: {
    ...
    'experience.rbk.description': 'إرشاد أكثر من 50 مطور مبتدئ في تطوير JavaScript full-stack. إنشاء منهج شامل يغطي React وNode.js وExpress وMongoDB. تقديم ورش عمل تقنية حول ممارسات التطوير الحديثة ومنهجيات الاختبار واستراتيجيات النشر. تحقيق معدل توظيف 85% خلال 6 أشهر من التخرج.',
