...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'contact.availability.status': 'Open to new opportunities',
    'contact.availability.timezone': 'EST timezone',
    'contact.social.title': 'Connect With Me',
    'contact.social.linkedin': 'LinkedIn',
    'contact.social.linkedin.description': 'Professional network',
    'contact.social.github': 'GitHub',
    'contact.social.github.description': 'Open source projects',
    'contact.social.email.description': 'Direct contact',
  ...
  fr: {
    ...
    'contact.availability.status': 'Ouvert aux nouvelles opportunités',
    'contact.availability.timezone': 'Fuseau horaire EST',
    'contact.social.title': 'Me Suivre',
    'contact.social.linkedin': 'LinkedIn',
    'contact.social.linkedin.description': 'Réseau professionnel',
    'contact.social.github': 'GitHub',
    'contact.social.github.description': 'Projets open source',
    'contact.social.email.description': 'Contact direct',
  ...
  ar: {
    ...
    'contact.availability.title': 'التوفر',
    'contact.availability.status': 'مفتوح للفرص الجديدة',
    'contact.availability.timezone': 'التوقيت الشرقي EST',
    'contact.social.title': 'تواصل معي',
    'contact.social.linkedin': 'لينكد إن',
    'contact.social.linkedin.description': 'الشبكة المهنية',
    'contact.social.github': 'جت هب',
    'contact.social.github.description': 'مشاريع المصدر المفتوح',
    'contact.social.email.description': 'تواصل مباشر',
    'contact.cta.title': 'مستعد للتعاون؟',
